...
import 'package:todolist/screens/help_center.dart';
    ...
    if (entereKeyword.isEmpty) {
      ...
      results = todosList
          .where((item) => item.todoText!
              .toLowerCase()
              .contains(entereKeyword.toLowerCase()))
          .toList();
    }
    setState(() {
      _foundToDo = results;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        iconTheme: const IconThemeData(color: Color(0xFFDEB887)),
      ),
      drawer: Drawer(
        elevation: 0,
        child: Column(
          children: [
            const UserAccountsDrawerHeader(
              currentAccountPicture: CircleAvatar(
                backgroundImage: AssetImage("assets/josef.jpeg"),
              ),
              accountName: Text("Joseph Wambua"),
              accountEmail: Text("josefwambua2@gmail.com"),
            ),
            ...
            //Hard coded ->Close the entire application
            ListTile(
              onTap: () {
                exit(0);
              },
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: Icon(
                    Icons.search,
                    color: Color.fromARGB(255, 255, 70, 2),
                    size: 20,
                  ),
